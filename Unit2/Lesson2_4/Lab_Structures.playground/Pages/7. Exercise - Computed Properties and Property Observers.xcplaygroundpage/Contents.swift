...
struct Height {
    var heightInInches: Double {
        didSet {
            let correctValue = heightInInches * 2.54
            if heightInCentimeters != correctValue {
                heightInCentimeters = correctValue
            }
        }
    }
    ...
    var heightInCentimeters: Double {
        didSet {
            let correctValue = heightInCentimeters / 2.54
            if heightInInches != correctValue {
                heightInInches = correctValue
            }
        }
    }
