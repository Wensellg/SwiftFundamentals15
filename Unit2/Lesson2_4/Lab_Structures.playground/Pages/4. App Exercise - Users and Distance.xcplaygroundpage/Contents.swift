...
var Grant = User(
    name: "Grant",
    age: 32,
    height: 73.0,     // 6'1" in inches
    weight: 185.0,    // example — replace with your own
    activityLevel: 7  // example score
)

print("User: \(Grant.name), age \(Grant.age), height \(Grant.height) inches, weight \(Grant.weight) lbs, activity level \(Grant.activityLevel).")
...
print(mile.feet)   // Should print 5249.344

//:  Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
let shortRun = Distance(feet: 500)
print(shortRun.meters)
print(shortRun.feet)
