...
let runningChallenges = ["Run 5 times a week", "Run a 10k"]
let liftingChallenges = ["Lift 3 days a week", "Bench press bodyweight"]
 ...
 */
let challenges = [walkingChallenges, runningChallenges, liftingChallenges]
